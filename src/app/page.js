  ...
  const stories = [
    {
      name: "Sanket & Shruti",
      imageUrl:
        "https://imagecdn.jeevansathi.com/21791/1/435821451-1610352014.jpg",
    ...
    },
    {
      name: "Akshay & Dipali",
      imageUrl:
        "https://imagecdn.jeevansathi.com/22640/7/452807301-1615017670.jpg",
    ...
    },
    {
      name: "Yash & Khushboo",
      imageUrl:
        "https://imagecdn.jeevansathi.com/22137/1/442741551-1612252806.jpg",
    ...
    },
    {
      name: "Vivek & Kavita",
      imageUrl:
        "https://imagecdn.jeevansathi.com/21549/0/430980537-1609056062.jpg",
      date: "25, November 2020",
      details:
    ...
    },
    {
      name: "Naveen & Soniya",
      imageUrl:
        "https://imagecdn.jeevansathi.com/22667/14/453354629-1615190452.jpg",
    ...
    },
    {
      name: "Prateek & Pooja",
      imageUrl:
        "https://imagecdn.jeevansathi.com/21596/1/431921933-1609315238.jpg",
      date: "25, November 2020",
      details:
    ...
    },
    {
      name: "Shaik & Farhat",
      imageUrl:
        "https://imagecdn.jeevansathi.com/22486/7/449727411-1614153606.jpg",
      date: "27, November 2020",
      details:
    ...
    },
    {
      name: "Nikit & Nimisha",
      imageUrl:
        "https://imagecdn.jeevansathi.com/21956/14/439134849-1611216077.jpg",
    ...
    },
    {
      name: "Mayank & Suneeta",
      imageUrl:
        "https://imagecdn.jeevansathi.com/22112/17/442257799-1612080012.jpg",
      date: "09, December 2020",
      details:
    ...
    },
    {
      name: "Bharat & Sakshi",
      imageUrl:
        "https://imagecdn.jeevansathi.com/22194/6/443886839-1612512014.jpg",
    ...
    <>
      ...
      <header
        className={`${styles.header} ${
          isScrolled
            ? styles.scrolled
            : "bg-transparent fixed top-0 z-20 w-full"
        }`}
      >
        <div className="container mx-auto flex items-center justify-between py-2 px-6">
          ...
          <nav className="hidden md:flex space-x-6">
            <a
              ...
              className={`${
                isScrolled
                  ? "text-black ease-in-oute duration-300 font-bold hover:text-orange-500 "
                  : "text-[#ffff] ease-in-oute duration-300 font-bold hover:text-orange-500"
              }`}
            >
              Home
            </a>
      ...
      <section
        ...
        style={{
          backgroundImage:
            "url('https://img2.shaadi.com/assests/2024/images/shaadi-north-desktop.webp')",
        }}
      >
        ...
        <div className="z-10 text-center text-white relative top-28">
          <h1
            className={`${styles.raleway} text-4xl md:text-5xl font-bold mb-4 wow animate__animated animate__fadeInDown`}
          >
      ...
      <div className="py-20 bg-gray-100 ">
        <div
          className="bg-[#2D1B47] rounded-lg p-6 mx-auto flex flex-col md:flex-row items-center w-[60%] justify-between gap-6 md:gap-10 wow animate__animated animate__backInUp
"
        >
          {/* Left Section */}
          <div className="flex flex-col md:w-2/3">
            <p className="text-2xl md:text-3xl text-[#d2b17c] font-semibold mb-2  font-[initial]">
              <span className={styles.playfair}>
                Exclusive & Personalised Matchmaking by Premium-matrimony.com
              </span>
            </p>
      ...
      <section className="bg-gray-100 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2
            className={`${styles.raleway} text-3xl text-orange-500 mb-8 !font-medium wow animate__animated animate__zoomIn`}
          >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
            ...
            <div className="flex flex-col items-center wow animate__animated animate__slideInLeft">
              <div className="bg-cyan-500 text-center shadow-lg hover:shadow-2xl duration-300 rounded-2xl p-5 relative cursor-pointer">
                <div className="absolute -bottom-3 -right-3 rounded-full text-orange-500 font-bold bg-white p-2 w-8 h-8 flex items-center justify-center">
                  1
                </div>
                <FontAwesomeIcon
                  icon={faEdit}
      ...
      <div className="flex justify-center">
        <div className="bg-white py-16 w-[60%]">
          <div className="text-center">
            <h1
              className={`${styles.raleway} text-3xl font-semibold text-orange-600 wow animate__animated animate__lightSpeedInLeft`}
            >
              Welcome to Matrimonywebsite
            </h1>
            <p className="text-lg mt-4 text-gray-600 wow animate__animated animate__lightSpeedInRight">
              Best matrimony service provider in India. We find the best perfect
              life partner for you. Join us now and find your life partner from
              our thousands of verified profiles.
            </p>
            <div
              className={`flex gap-4 justify-center items-center pt-3 relative wow animate__animated animate__zoomIn`}
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mt-12">
            ...
            <div className="text-center shadow-lg hover:shadow-2xl duration-300 rounded-2xl p-5 flex justify-between flex-col items-center wow animate__animated animate__fadeInLeft">
              <div>
                ...
                <p className="mt-2 text-gray-600">
                  Hundreds of successful members found their soulmates with us.
                </p>
              </div>
              <a href="#" className="text-orange-600 mt-4 block">
            ...
            <div className="text-center shadow-lg hover:shadow-2xl duration-300 rounded-2xl p-5 flex justify-between flex-col items-center wow animate__animated animate__fadeInLeftBig">
              <div>
                ...
                <p className="mt-2 text-gray-600">
                  Thousands of verified member profiles.
                </p>
              </div>
              <a href="#" className="text-orange-600 mt-4 block">
                View Profiles Now &rarr;
              </a>
            </div>
            ...
            <div className="text-center shadow-lg hover:shadow-2xl duration-300 rounded-2xl p-5 flex justify-between flex-col items-center wow animate__animated animate__fadeInRightBig">
              <div>
                ...
                <p className="mt-2 text-gray-600">
                  Find a partner who knows you better.
                </p>
              </div>
              <a href="#" className="text-orange-600 mt-4 block">
                Search Now &rarr;
            ...
            {/* Matching Profiles */}
            <div
              className="text-center shadow-lg hover:shadow-2xl duration-300 rounded-2xl p-5 flex justify-between flex-col items-center wow animate__animated animate__fadeInRight
"
            >
              <div>
                ...
                <p className="mt-2 text-gray-600">
                  Auto-match profiles to find your best match.
                </p>
              </div>
              <a href="#" className="text-orange-600 mt-4 block">
                View Matches Now &rarr;
              </a>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-5xl mx-auto py-8 px-4 ">
        ...
        <h2 className="text-center text-2xl font-semibold text-gray-900 py-4 wow animate__animated animate__fadeInDown">
          Matched by{" "}
          <span className="text-orange-500 font-medium">Premium Matrimony</span>
        </h2>
                    ...
                    <div className="relative w-[280px] h-[228px] group">
                      ...
                      >
                        ...
                        <div className="absolute inset-0 flex flex-col justify-end items-center text-white p-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300 ease-in-out">
                          <h3 className="text-4xl mb-2 drop-shadow-md">
                            {story.name}
                          </h3>
        ...
        <div className="w-[90%] md:w-[60%] lg:w-[50%]">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className=" p-6 rounded flex justify-center flex-col">
              ...
              <h1 className="text-orange-500 text-3xl font-bold wow animate__animated animate__fadeInUp">
                Download App Now !
              </h1>
      ...
      <footer className="bg-white dark:bg-gray-900">
        <div className="mx-auto w-full max-w-screen-xl">
          <div className="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4">
            <div>
              <h2 className="mb-6 text-sm font-semibold text-orange-500  dark:text-white wow animate__animated animate__fadeInUp">
                Help And Support
              </h2>
              <ul className="text-gray-600 dark:text-gray-400 font-medium">
                ...
                <li className="mb-4 wow animate__animated animate__fadeInUp">
                  <a
                    href="#"
                    className="hover:underline wow animate__animated animate__fadeInUp"
                  >
                    Welcome to Matrimonywebsite
                  </a>
                </li>
        ...
        <div className="px-4 py-6 bg-gray-100 dark:bg-gray-800 flex flex-col md:flex-row md:items-center justify-center md:justify-between w-full">
          <div className="w-full flex flex-col md:flex-row justify-between items-center md:items-start px-40">
            ...
            <div className="flex space-x-5 rtl:space-x-reverse justify-center md:justify-start">
              <a
                href="#"
                className="text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors duration-300 wow animate__animated animate__fadeInRightBig"
              >
              ...
              <a
                href="#"
                className="text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors duration-300 wow animate__animated animate__fadeInRightBig"
              >
              ...
              <a
                href="#"
                className="text-gray-400 hover:text-blue-400 dark:hover:text-blue-300 transition-colors duration-300 wow animate__animated animate__fadeInRightBig"
              >
              ...
              <a
                href="#"
                className="text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors duration-300 wow animate__animated animate__fadeInRightBig"
              >
              ...
              <a
                href="#"
                className="text-gray-400 hover:text-pink-500 dark:hover:text-pink-400 transition-colors duration-300 wow animate__animated animate__fadeInRightBig"
              >
